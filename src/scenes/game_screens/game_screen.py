...
def GameScreen(player):
	...
	os.system("clear")
	print(f"        ┏━━━━━━━━━━━━━━┓        ┏━━━━━━━━━━━━━━┓        ┏━━━━━━━━━━━━━━┓        ┏━━━━━━━━━━━━━━┓")
	print(f"┏━━━━━━━┫  {CYAN}[ PUREYA ]{WHITE}  ┣━━━━━━━━┫ {GREEN}[HP] {hp}/100{WHITE} ┣━━━━━━━━┫ {RED}[ COMMS ] --{WHITE} ┣━━━━━━━━┫ {BLUE}[ SETTINGS ]{WHITE} ┣━━━[ {YELLOW}TASUKU{WHITE} ]━━━┓")
	print(f"┃       ┗━━━━━━━━━━━━━━┛        ┗━━━━━━━━━━━━━━┛        ┗━━━━━━━━━━━━━━┛        ┗━━━━━━━━━━━━━━┫                ┃")
	...
	print(f"┃ {YELLOW}┣" + (f"━" * (len(location_name) + 2)) + f"┛{WHITE}" + (f" " * (71 - (len(location_name) + 2))) + f"                    ┃                ┃")
	print(f"┃ {YELLOW}┣╸{WHITE}{line_1}" + (f" " * (71 - (len(line_1)))) + f"                    ┃                ┃")
	print(f"┃ {YELLOW}┣╸{WHITE}{line_2}" + (f" " * (71 - (len(line_2)))) + f"                    ┃                ┃")
	print(f"┃ {YELLOW}┣╸{WHITE}{line_3}" + (f" " * (71 - (len(line_3)))) + f"                    ┃                ┃")
	print(f"┃ {YELLOW}┗╸{WHITE}{line_4}" + (f" " * (71 - (len(line_4)))) + f"                    ┃                ┃")
	print(f"┃   🮥  " + location_object_1["description"] + (f" " * (74 - (len(location_object_1["description"]) + 6))) + f"                    ┃                ┃")
	print(f"┃   🮥  " + location_object_1["description"] + (f" " * (74 - (len(location_object_1["description"]) + 6))) + f"                    ┃                ┃")
	print(f"┃   🮥  " + location_object_2["description"] + (f" " * (74 - (len(location_object_2["description"]) + 6))) + f"                    ┃                ┃")
	print(f"┃   🮥  " + location_entity_1["description"] + (f" " * (74 - (len(location_entity_1["description"]) + 6))) + f"                    ┃                ┃")
	print(f"┃   🮥  " + location_entity_2["description"] + (f" " * (74 - (len(location_entity_2["description"]) + 6))) + f"┏━━━━━[ {YELLOW}YOROI{WHITE} ]━━━━━┻━━━━━━━━━━━━━━━━┫")
	print(f"┃                                                                          ┃                                    ┃")
