...
def GameScreen(player):
	...
	print(f"┃ {BLUE}┏╸{WHITE}{parts_descriptions[0]}" + (f" " * (71 - (len(parts_descriptions[0])))) + f"┃ {BLUE}┣╸{WHITE}{inventory[8]}" + (" " * (36 - (len(inventory[8]) + 3))) + "┃")
	print(f"┃ {BLUE}┣╸{WHITE}{parts_descriptions[1]}" + (f" " * (71 - (len(parts_descriptions[1])))) + f"┃ {BLUE}┣╸{WHITE}{inventory[9]}" + (" " * (36 - (len(inventory[9]) + 3))) + "┃")
	print(f"┃ {BLUE}┗╸{WHITE}{parts_descriptions[2]}" + (f" " * (71 - (len(parts_descriptions[2])))) + f"┃ {BLUE}┣╸{WHITE}{inventory[10]}" + (" " * (36 - (len(inventory[10]) + 3))) + "┃")
